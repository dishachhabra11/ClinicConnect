...
function ClinicPage() {
  ...
  const images = [
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSijvd4SoCLhCabJX9TEf10C84TzVGhBqSeyg&s",
    ...
    <div>
      ...
      <div className="p-4 bg-background flex sm:flex-row flex-col">
        <div className="bg-white flex-2 sm:w-1/3 h-[200px] sm:h-[400px] sm:p-6 overflow-hidden">
          <Carousel images={clinic.images || images} />
        </div>
        ...
        <div className="bg-white flex-1 h-[400px] p-6 flex flex-col gap-1">
          ...
          <div className="my-4 text-2xl font-bold flex">
            ...
            <div className="flex flex-col px-2">
              <p className="font-medium font-inter text-xl text-slate-800">Dr. John Doe</p>
              <p className="font-light font-inter text-sm text-slate-800">General Physician</p>
            </div>
          </div>
          <div className="flex gap-3 my-2 sm:w-[50%]">
            <div
              ...
              onClick={() =>
                navigate(`/queue/${id}`, { state: { clinic } })
              }>
